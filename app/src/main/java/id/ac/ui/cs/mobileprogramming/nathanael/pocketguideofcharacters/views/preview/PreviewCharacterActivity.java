...
import id.ac.ui.cs.mobileprogramming.nathanael.pocketguideofcharacters.views.update.UpdateCharacterActivity;

public class PreviewCharacterActivity extends AppCompatActivity {
    ...
    private void refreshData() {
        ValueEventListener valueEventListener = new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(PreviewCharacterActivity.this, "No Internet Connection!", Toast.LENGTH_SHORT).show();
            }
        };
    ...
    private void rerenderCharacterView() {
        if (mainCharacter != null) {
            ...
            deleteButtonClickListener = v -> new MaterialAlertDialogBuilder(PreviewCharacterActivity.this, R.style.DeleteDialogTheme)
                    ...
                    .setPositiveButton("Delete", (dialogInterface, i) -> firebaseConnectorService.mDatabase.child("characters").child(mainCharacter.id).addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                            ...
                            photoRef.delete().addOnSuccessListener(aVoid -> {
                                ...
                                finish();
                                Toast.makeText(PreviewCharacterActivity.this, "Character Deletion Complete", Toast.LENGTH_SHORT).show();
                            }).addOnFailureListener(exception -> {
                                // Uh-oh, an error occurred!
                                Toast.makeText(PreviewCharacterActivity.this, "Error deleting image", Toast.LENGTH_SHORT).show();
                            });
                        }
